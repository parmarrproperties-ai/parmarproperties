...
<<<<<<< HEAD
        {services.ctaSection.body}
        <span className="text-white/40">
          {services.ctaSection.bodyMuted}
=======
        We guide you through every stage of your real estate journey with honest advice, market expertise,{" "}
        <span className="text-white/40">
          and a commitment to helping you make the right decision.
>>>>>>> efc0caeafe50b585c1d6ed32850f70cc46c268aa
        </span>
      </h3>

      <a
        href={services.ctaSection.ctaButton.href}
      ...
      >
        <span>{services.ctaSection.ctaButton.label}</span>
