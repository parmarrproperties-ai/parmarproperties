...
const TestimonialV2 = () => (
 ...
 <h2 className="text-xs font-semibold tracking-[0.25em] uppercase text-gray-400 mb-12">Client Experiences</h2>
 <span className="block text-6xl text-gray-200 mb-4 font-serif">"</span>
 <p className="text-3xl md:text-5xl font-light leading-tight text-black mb-14">
...
const TestimonialV3 = () => (
 ...
 <div>
 <p className="text-white font-semibold uppercase tracking-wider text-sm">{item.author}</p>
...
const TestimonialV4 = () => (
 ...
 <p className="text-gray-600 text-base leading-relaxed mb-8 flex-1">"{item.quote}"</p>
...
"Finding a home in South Mumbai is as much about patience as it is about access. The team secured our dream duplex before it even hit the open market."
 ...
 <p className="font-semibold tracking-[0.2em] uppercase text-sm">Anonymous</p>
