...
`}</style>
 ...
 <ScrollReveal direction="up"delay={0}>
 <h2 className="text-[36px] md:text-[52px] text-black mb-4 text-center">
 ...
 <h2 className="text-[36px] md:text-[48px] text-black mb-8">
 ...
 <h2 className="text-[36px] md:text-[52px] text-black">
 ...
 <span className="text-[64px] md:text-[84px] text-black/10 leading-[1.1]">01</span>
 ...
 <div className="p-10 md:p-16 flex flex-col gap-6 transition-all duration-500 ease-out hover:-translate-y-2 hover:shadow-xl hover:bg-neutral-50 cursor-default">
 <ScrollReveal delay={200}>
 <span className="text-[64px] md:text-[84px] text-black/10 leading-[1.1]">02</span>
 ...
 <span className="text-[64px] md:text-[84px] text-black/10 leading-[1.1]">03</span>
 ...
 <ScrollReveal direction="up"delay={0}>
 <h2 className="text-[40px] md:text-[56px] text-white leading-[1.1] mb-8">
 ...
 <span className="text-[64px] md:text-[96px] text-black/20 leading-[1.1]">“</span>
 </ScrollReveal>
 <ScrollReveal delay={200}>
 <ScrollScrubRevealText
 as="p"
 className="text-[26px] md:text-[42px] lg:text-[52px] tracking-[-0.03em] leading-[1.2] text-balance mb-12"
 ...
 <h2 className="text-[32px] md:text-[46px] text-black mb-4">
 ...
 <ScrollReveal direction="up"delay={100}>
 <h2 className="text-[36px] md:text-[52px] font-normal leading-[1.1] tracking-tight text-black">
