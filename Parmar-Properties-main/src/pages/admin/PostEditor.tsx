        ...
        <div className="flex-1 flex flex-col gap-3">
          ...
          {section.paragraphs.map((para, i) => (
            <div key={i} className="flex gap-2 items-start">
              <textarea
                ...
                className="flex-1 text-sm bg-neutral-50 border border-black/8 rounded-lg px-3 py-2 outline-none focus:ring-1 focus:ring-black/15 resize-none placeholder-black/45"
              />
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full text-sm bg-neutral-50 border border-black/8 rounded-lg px-3 py-2 outline-none focus:ring-1 focus:ring-black/15 resize-none placeholder-black/45"
            />
          </div>
        </div>
        <button
...
export const PostEditor = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#f8f7f4] flex items-center justify-center font-['Instrument_Sans']">
  ...
  return (
    <div className="min-h-screen bg-[#f8f7f4] font-['Instrument_Sans']">
      {/* Leave Warning Modal */}
      {showLeaveWarning && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm px-4">
          <div className="bg-white rounded-2xl p-6 shadow-xl max-w-md w-full font-['Instrument_Sans']">
                ...
                {editorState.intro.map((para, i) => (
                  <div key={i} className="flex gap-2 items-start">
                    <textarea
                      ...
                      className="flex-1 text-sm bg-neutral-50 border border-black/8 rounded-xl px-4 py-3 outline-none focus:ring-1 focus:ring-black/15 resize-none placeholder-black/45"
                    />
